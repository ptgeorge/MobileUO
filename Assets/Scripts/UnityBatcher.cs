...
namespace ClassicUO.Renderer
{
    public sealed unsafe class UltimaBatcher2D : IDisposable
    {
        ...
        {
            // TODO: MobileUO - validate if any update is needed
            // MobileUO: Removed EnsureSize
            //EnsureSize();
        ...
        {
            // TODO: MobileUO - validate if any updates are needed
            EnsureNotStarted();
            _started = true;
            TextureSwitches = 0;
            FlushesDone = 0;
        ...
        */
        ...
        {
            // MobileUO: Removed Flush
            //Flush();
            _blendState = blend ?? BlendState.AlphaBlend;
            // MobileUO: Call ApplyStates
            ApplyStates();
        }
